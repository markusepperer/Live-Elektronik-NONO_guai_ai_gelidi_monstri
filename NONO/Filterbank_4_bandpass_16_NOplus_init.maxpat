        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "text": "filterdesign @topology butterworth @order 14 @response bandpass @frequency 97.999 110.000",
                    "outlettype": [
                        "dictionary"
                    ],
                    "numinlets": 1,
            ...
            },
            {
                "box": {
                    ...
                    "text": "filterdesign @topology butterworth @order 14 @response bandpass @frequency 195.998 220.000",
                    "outlettype": [
                        "dictionary"
                    ],
                    "numinlets": 1,
            ...
            },
            {
                "box": {
                    ...
                    "text": "filterdesign @topology butterworth @order 14 @response bandpass @frequency 391.995 440.000",
                    "outlettype": [
                        "dictionary"
                    ],
                    "numinlets": 1,
            ...
            },
            {
                "box": {
                    ...
                    "text": "filterdesign @topology butterworth @order 14 @response bandpass @frequency 783.991 880.000",
                    "outlettype": [
                        "dictionary"
                    ],
                    "numinlets": 1,
